    ...
    , m_altGraphKey(false)
{
    ...
    m_charCode = static_cast<int>(text.characterStartingAt(0));
}
...
void KeyboardEvent::setKeyCode(int code){
    m_charCode = code;
    printf("SETTING CHAR CODE TO %d\n", code);
}

void KeyboardEvent::setCharCode(int code){
    setKeyCode(code);
}
